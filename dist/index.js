...
admin.initializeApp();
const envRunning = process.env.ENVIRONMENT === 'hospital' ? configDBs_1.default.test : configDBs_1.default.dev;
app_1.default.listen(PORT, () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const sequelize = (0, models_1.startSequelize)({
            dbName: envRunning.database,
            dbPassword: envRunning.password,
            dbHostname: envRunning.host,
            dbUsername: envRunning.username
        });
        yield sequelize.sync({ force: process.env.ENVIRONMENT === 'hospital' });
